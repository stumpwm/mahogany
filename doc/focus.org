...
focus can be controlled separately in Mahogany, and there are various
...
* Stumpwm focus
  Since Mahogany is descended from stumpwm, it is useful to note that
