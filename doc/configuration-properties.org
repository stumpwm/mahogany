...
One of the main ways that mahogany can be customized is through the
use of /configuration properties/. These properties can be searched,
viewed and modified through a series of functions and macros.

** Discovering Configuration Properties

To get the full list of available properties, evaluate the
...
Mahogany configuration properties are strongly typed,
